@mixin primer-colors_v2-light {
  & {
    ...
    --color-fg-inactive: #6a737d;
    --color-fg-on-emphasis: #ffffff;
    --color-canvas-default: #ffffff;
    --color-canvas-overlay: #ffffff;
    --color-canvas-inset: #f6f8fa;
    --color-canvas-backdrop: rgba(27,31,35,0.5);
    --color-canvas-mobile: #ffffff;
    --color-border-default: #e1e4e8;
    --color-border-divider: #eaecef;
    ...
    --color-border-warning: #ffd33d;
    --color-neutral-fg: #6a737d;
    --color-neutral-emphasis: #6a737d;
    --color-neutral-highlighter: #d1d5da;
    --color-neutral-muted: #f6f8fa;
    --color-accent-fg: #0366d6;
    --color-accent-emphasis: #0366d6;
    --color-accent-highlighter: #c8e1ff;
    --color-accent-muted: #f1f8ff;
    --color-success-fg: #22863a;
    --color-success-emphasis: #28a745;
    --color-success-highlighter: #85e89d;
    --color-success-muted: #dcffe4;
    --color-warning-fg: #b08800;
    --color-warning-emphasis: #ffd33d;
    --color-warning-highlighter: #ffea7f;
    --color-warning-muted: #fff5b1;
    --color-severe-fg: #f66a0a;
    --color-severe-emphasis: #f66a0a;
    --color-severe-highlighter: #ffab70;
    --color-severe-muted: #ffebda;
    --color-danger-fg: #cb2431;
    --color-danger-emphasis: #d73a49;
    --color-danger-highlighter: #fdaeb7;
    --color-danger-muted: #ffeef0;
    --color-done-fg: #6f42c1;
    --color-done-emphasis: #6f42c1;
    --color-done-highlighter: #d1bcf9;
    --color-done-muted: #f5f0ff;
    --color-sponsors-fg: #ea4aaa;
    --color-sponsors-emphasis: #ea4aaa;
    --color-sponsors-highlighter: #f9b3dd;
    --color-sponsors-muted: #ffeef8;
    ...
    --color-alert-info-icon: #0366d6;
    --color-alert-info-bg: #f1f8ff;
    --color-alert-info-border: #c8e1ff;
    --color-alert-warn-text: #24292e;
    --color-alert-warn-icon: #b08800;
    --color-alert-warn-bg: #fff5b1;
    --color-alert-warn-border: #ffea7f;
    --color-alert-error-text: #24292e;
    --color-alert-error-icon: #cb2431;
    --color-alert-error-bg: #ffeef0;
    --color-alert-error-border: #fdaeb7;
    --color-alert-success-text: #24292e;
    --color-alert-success-icon: #22863a;
    --color-alert-success-bg: #dcffe4;
    --color-alert-success-border: #85e89d;
    --color-autocomplete-row-border: #eaecef;
    --color-blankslate-icon: #586069;
    ...
    --color-counter-bg: #f6f8fa;
    --color-counter-primary-text: #ffffff;
    --color-counter-primary-bg: #6a737d;
    --color-counter-secondary-text: #586069;
    --color-counter-secondary-bg: #f6f8fa;
    ...
    --color-label-warning-text: #b08800;
    --color-label-warning-border: #ffd33d;
    --color-label-danger-text: #cb2431;
    --color-label-danger-border: #d73a49;
    --color-label-orange-text: #f66a0a;
    ...
    --color-input-warning-border: #ffd33d;
    --color-input-error-border: #d73a49;
    --color-input-tooltip-success-text: #24292e;
    --color-input-tooltip-success-bg: #dcffe4;
    --color-input-tooltip-success-border: #85e89d;
    --color-input-tooltip-warning-text: #24292e;
    --color-input-tooltip-warning-bg: #fff5b1;
    --color-input-tooltip-warning-border: #ffea7f;
    --color-input-tooltip-error-text: #24292e;
    --color-input-tooltip-error-bg: #ffeef0;
    --color-input-tooltip-error-border: #fdaeb7;
    ...
    --color-toast-loading-icon-bg: #6a737d;
    --color-timeline-text: #586069;
    --color-timeline-badge-bg: #f6f8fa;
    --color-timeline-target-badge-border: #0366d6;
    ...
    --color-box-row-yellow-bg: #fff5b1;
    --color-box-row-blue-bg: #f1f8ff;
    --color-box-header-blue-bg: #f1f8ff;
    --color-box-header-blue-border: #c8e1ff;
    --color-box-border-info: #c8e1ff;
    --color-box-bg-info: #f1f8ff;
    --color-box-border-warning: #ffea7f;
    --color-box-bg-warning: #fff5b1;
    --color-branch-name-text: #586069;
    --color-branch-name-icon: #586069;
    --color-branch-name-bg: #f6f8fa;
    --color-branch-name-link-text: #0366d6;
    --color-branch-name-link-icon: #0366d6;
    --color-branch-name-link-bg: #f1f8ff;
    --color-markdown-code-bg: #f6f8fa;
    --color-markdown-frame-border: #e1e4e8;
    --color-markdown-blockquote-border: #e1e4e8;
    --color-markdown-table-border: #e1e4e8;
    --color-markdown-table-tr-border: #eaecef;
    --color-menu-heading-text: #24292e;
    --color-header-text: rgba(255,255,255,0.7);
    --color-header-bg: #24292e;
    --color-header-logo: #ffffff;
    --color-filter-item-bar-bg: #f6f8fa;
    --color-hidden-text-expander-bg: #d1d5da;
    --color-drag-and-drop-border: #e1e4e8;
    --color-upload-enabled-border: #e1e4e8;
    --color-previewable-comment-form-border: #e1e4e8;
    ...
    --color-underlinenav-icon: #6a737d;
    --color-underlinenav-icon-hover: #6a737d;
    --color-underlinenav-icon-active: #24292e;
    --color-underlinenav-counter-text: #24292e;
    --color-underlinenav-counter-bg: #f6f8fa;
    ...
    --color-files-explorer-icon: #0366d6;
    --color-hl-author-bg: #f1f8ff;
    --color-hl-author-border: #c8e1ff;
    --color-logo-subdued: #d1d5da;
    --color-discussion-border: #85e89d;
    --color-discussion-bg-success: #28a745;
    --color-code-selection-bg: #c8e1ff;
    --color-highlight-text: #24292e;
    --color-highlight-bg: #fff5b1;
    --color-blob-line-highlight-bg: #fff5b1;
    --color-blob-line-highlight-border: #ffea7f;
    --color-diff-addition-text: #22863a;
    --color-diff-addition-bg: #dcffe4;
    --color-diff-addition-border: #85e89d;
    --color-diff-deletion-text: #cb2431;
    --color-diff-deletion-bg: #ffeef0;
    --color-diff-deletion-border: #fdaeb7;
    --color-diff-change-text: #b08800;
    --color-diff-change-bg: #fff5b1;
    --color-diff-change-border: #ffea7f;
    --color-diff-blob-num-text: #6a737d;
    --color-diff-blob-addition-num-text: #22863a;
    --color-diff-blob-addition-num-bg: #85e89d;
    --color-diff-blob-addition-line-bg: #dcffe4;
    --color-diff-blob-addition-word-bg: #85e89d;
    --color-diff-blob-deletion-num-text: #cb2431;
    --color-diff-blob-deletion-num-bg: #fdaeb7;
    --color-diff-blob-deletion-line-bg: #ffeef0;
    --color-diff-blob-deletion-word-bg: #fdaeb7;
    --color-diff-blob-hunk-text: #586069;
    --color-diff-blob-hunk-num-bg: #c8e1ff;
    --color-diff-blob-hunk-line-bg: #f1f8ff;
    --color-diff-blob-empty-block-bg: #f6f8fa;
    ...
    --color-footer-invertocat-octicon: #6a737d;
    --color-footer-invertocat-octicon-hover: #586069;
    ...
    --color-topic-tag-hover-bg: #c8e1ff;
    --color-topic-tag-active-bg: #f1f8ff;
    ...
    --color-merge-box-warning-icon-bg: #ffd33d;
    ...
    --color-codemirror-guttermarker-subtle-text: #6a737d;
    --color-codemirror-linenumber-text: #586069;
    --color-codemirror-cursor: #24292e;
    --color-codemirror-selection-bg: #f1f8ff;
    --color-codemirror-activeline-bg: #f6f8fa;
